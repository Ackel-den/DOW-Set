...
/* БАГИ И НЕРЕШЁННЫЕ ЗАДАЧИ:
 ...
 происходит проверка на сет
    ...
    - deal - сначала даёт карты в колоду, а потом, после нажатия выдёт ещё три
        если сделать первое нажатие на колоду карт - 12 карт выдаёт, а далее по три карты(???)
    - не освобождается место
 */
